...
### To run it
sudo ./decanter.py config.devel start|stop|restart|status

**config.devel** must match the location of a module containing decanter required configuration items, i.e. config/devel.py
